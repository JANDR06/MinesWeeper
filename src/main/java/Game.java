public class Game {
    ...
    public static void menu() {
        ...
        System.out.println(ANSI_BLUE + "¡ WELCOME TO THE MINESWEEEPER !" + ANSI_RESET);
        System.out.println(ANSI_CYAN + "1" + ANSI_RESET + " - Play");
        int number = Get.getIntegerBelow(ANSI_CYAN + "2" + ANSI_RESET + " - Exit");

        while (number > 2 || number < 1) {
            number = Get.getIntegerBelow(Get.ANSI_RED + "¡¡ ERROR NUMBER, WRITE 1 OR 2 !!" + ANSI_RESET);
        }
        ...
        if (number == 1) {
            ...
            System.out.println(ANSI_BLUE + "SEE YOU SOON !" + ANSI_RESET);
        }
    }

    public static void instructions() {
        System.out.println();
        System.out.println(ANSI_BLUE + "------------------------------------------------- INSTRUCTIONS -------------------------------------------------" + ANSI_RESET);
        System.out.println();
